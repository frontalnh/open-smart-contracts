...
contract GeneralKIP7 is KIP7Burnable, KIP7Pausable, KIP7Metadata, Ownable {
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 supply) KIP7Metadata(name,symbol,decimals) public {
